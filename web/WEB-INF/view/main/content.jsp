            ...
            <div id="advert1" class="advert currentAdvert">
                ...
                <img src="${pageContext.request.contextPath}/images/world-map.png"/>
            </div>     
            <div id="advert2" class="advert hidden">
                ...
                <img src="${pageContext.request.contextPath}/images/folders.png"/>
            </div>
            <div id="advert3" class="advert hidden">
                ...
                <img src="${pageContext.request.contextPath}/images/traffic-graph.png"/>
            </div>  